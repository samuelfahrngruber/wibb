...
db.beers.insert({ name: "Stiegl", icon: "/res/img/beer/stiegl.png", meta: { iconBg: "#ffffff" } });
...
db.beers.insert({ name: "Zipfer", icon: "/res/img/beer/zipfer.png", meta: { iconBg: "#ffffff" } });
